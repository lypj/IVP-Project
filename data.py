...
def getFitLoaders(trn_path_list =['CBSD432'],
	...
	dataloaders = {'train': getDataLoader(trn_path_list, batch_size[0], load_color, crop_size=crop_size, test=False),
	               'val':   getDataLoader(val_path_list, batch_size[1], load_color, test=True),
	               'test':  getDataLoader(tst_path_list, batch_size[2], load_color, test=True)}
	return dataloaders
